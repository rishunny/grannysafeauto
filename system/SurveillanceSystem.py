...
class SurveillanceSystem(object):
   ...
   def __init__(self):
        ...
        # self.cameras.append(Camera.IPCamera(0,"detect_recognise_track",False))
           ...
           with self.alertsLock:
              for alert in self.alerts:
                ...
                if alert.action_taken == False: # If action hasn't been taken for event 
                    ...
                    if (time.time() - alert.eventTime) > 30: # Reinitialize event 5 min after event occured
   ...
   def send_email_notification_alert(self,alert):
      ...
      msg['From'] = fromaddr
      msg['To'] = toaddr
      msg['Subject'] = "HOME SURVEILLANCE FOR GRANDMA"
...
class Alert(object): 
    ...
    def __init__(self,alarmState,camera, event, person, actions, emailAddress, confidence):   
        ...
        if emailAddress == None:
            self.emailAddress = "austin316says@yahoo.com"
        else:
